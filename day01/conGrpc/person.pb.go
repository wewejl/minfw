...
func init() {
	proto.RegisterType((*Request)(nil), "conGrpc.Request")
	proto.RegisterType((*Response)(nil), "conGrpc.Response")
}
...
var fileDescriptor_4c9e10cf24b1156d = []byte{
	...
	0xce, 0xcf, 0xd3, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x4f, 0xce, 0xcf, 0x73, 0x2f, 0x2a,
	0x48, 0x56, 0xd2, 0xe7, 0x62, 0x0f, 0x4a, 0x2d, 0x2c, 0x4d, 0x2d, 0x2e, 0x11, 0x12, 0xe2, 0x62,
	0xc9, 0x4b, 0xcc, 0x4d, 0x95, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x02, 0xb3, 0x85, 0x04, 0xb8,
	0x98, 0x13, 0xd3, 0x53, 0x25, 0x98, 0x14, 0x18, 0x35, 0x58, 0x83, 0x40, 0x4c, 0x25, 0x19, 0x2e,
	0x8e, 0xa0, 0xd4, 0xe2, 0x82, 0xfc, 0xbc, 0x62, 0x2c, 0xb2, 0x46, 0x56, 0x5c, 0x6c, 0x01, 0x60,
	0x7b, 0x84, 0x0c, 0xb8, 0x38, 0xdd, 0x53, 0x4b, 0xa0, 0x1c, 0x01, 0x3d, 0xa8, 0x7d, 0x7a, 0x50,
	0xcb, 0xa4, 0x04, 0x91, 0x44, 0x20, 0xa6, 0x25, 0xb1, 0x81, 0x9d, 0x66, 0x0c, 0x08, 0x00, 0x00,
	0xff, 0xff, 0x75, 0xa4, 0x5e, 0x55, 0xaa, 0x00, 0x00, 0x00,
}
...
type PersonClient interface {
	//    rpc
	GetPerson(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *personClient) GetPerson(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/conGrpc.Person/GetPerson", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PersonServer interface {
	//    rpc
	GetPerson(context.Context, *Request) (*Response, error)
}
...
func (*UnimplementedPersonServer) GetPerson(ctx context.Context, req *Request) (*Response, error) {
...
func _Person_GetPerson_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/conGrpc.Person/GetPerson",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServer).GetPerson(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}

var _Person_serviceDesc = grpc.ServiceDesc{
	ServiceName: "conGrpc.Person",
